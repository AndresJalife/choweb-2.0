    ...
    return (
        <div className={'ursi-container'} style={{textAlign: '-webkit-center'}}>
            ...
            <div className={'vertical-gifs-container'} style={{width: '25%'}}>
                <img src={'https://d2njbbkhc1pb2y.cloudfront.net/public/resources/Ursi-Coin-3Alpha.gif'} alt={'ursi-img'}
                     style={{width: '100%'}}/>
                <img src={'https://d2njbbkhc1pb2y.cloudfront.net/public/resources/Ursi-Coin-3Alpha2-min.gif'} alt={'ursi-img'}
                     style={{width: '100%'}}/>
            </div>
        </div>
    )
